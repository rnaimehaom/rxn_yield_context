...
class ReactionDatapoint:
    ...
    def __init__(self,
        ...
        self.rxn_fp = create_rxn_Morgan2FP_concatenate(self.r_smiles, self.p_smiles, fpsize=fpsize, radius=radius)
        self.solvent = None
        self.reagent = None
...
def construct_reaction_batch(data, morgan: bool = True) -> ReactionDataset: #TODO: change
    r"""
...
class ReactionDataLoader(DataLoader): #TODO: change
    ...
    def __init__(self,
        ...
        super(ReactionDataLoader, self).__init__(
            ...
            collate_fn=partial(construct_reaction_batch, morgan=self._morgan)
        )
