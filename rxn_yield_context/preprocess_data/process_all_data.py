...
if __name__ == '__main__':
    ...
    f = open(solvent_emerge_file, 'r', encoding="utf-8")
    ...
    f = open(reagent_emerge_file, 'r', encoding="utf-8")
    ...
    for file in files:
        f = open(os.path.join(first_data_path,'Splitted_first_{}.txt'.format(file)), 'r', encoding="utf-8")
        data = f.readlines()
        f.close()
        ...
        f = open(os.path.join(first_data_path, 'Splitted_first_{}_labels_processed.txt'.format(file)), 'w', encoding="utf-8")
        f.writelines(data)
        f.close()
    ...
    files = ['test', 'validate', 'train']
    for file in files:
        f = open(os.path.join(second_data_path,'Splitted_second_{}.txt'.format(file)), 'r', encoding="utf-8")
        data = f.readlines()
        f.close()
        ...
        f = open(os.path.join(second_data_path, 'Splitted_second_{}_labels_processed.txt'.format(file)), 'w', encoding="utf-8")
        f.writelines(data)
        f.close()